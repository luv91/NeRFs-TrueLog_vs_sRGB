...
class Config:
    ...
    batch_size: int = 2 ** 17  # The number of rays/pixels in each batch.
    # batch_size: int = 2 ** 10
    ...
    max_steps: int = 20100  # The number of optimization steps.
    # max_steps: int = 2000  # The number of optimization steps.
    ...
    # data_loss_type: str = 'mse'  # What kind of loss to use ('mse' or 'charb').
    ...
    lr_delay_mult = 1e-3  # Gradual warm-up of the learning rate
...
# #     
    ...
    # rawnerf_mode: bool = True  # Load raw images and train in raw color space.
