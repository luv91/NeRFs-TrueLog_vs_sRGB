...
# SCENE=GX010431_LLFF_Processed
SCENE=GX010455_LLFF_Processed
# SCENE=GX010555_LLFF_Processed
DATA_ROOT=/work/SuperResolutionData/LuvNeRF/videos/LogNeRFStudioProcessed

# EXPERIMENT=llff_truelog/"$SCENE"  # Checkpoints, results, logs will be saved to exp/${EXPERIMENT}.
EXPERIMENT=llff_lr1eminus2to1eminus3/"$SCENE"  # Checkpoints, results, logs will be saved to exp/${EXPERIMENT}.
