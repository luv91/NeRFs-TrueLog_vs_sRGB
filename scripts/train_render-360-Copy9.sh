...
# SCENE=GX010431_LLFF_Processed
SCENE=GX010405_LLFF_Processed
# SCENE=GX010555_LLFF_Processed
DATA_ROOT=/work/SuperResolutionData/LuvNeRF/videos/LogNeRFStudioProcessed

EXPERIMENT=llff_reduced_parameters_truelog/"$SCENE"  # Checkpoints, results, logs will be saved to exp/${EXPERIMENT}.
DATA_DIR="$DATA_ROOT"/"$SCENE"

# Create the results directory if it doesn't exist
RESULTS_DIR=/work/SuperResolutionData/LuvNeRF/results360
# mkdir -p "$RESULTS_DIR"
