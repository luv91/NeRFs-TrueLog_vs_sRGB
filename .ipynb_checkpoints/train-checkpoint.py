    ...
    with logging_redirect_tqdm():
        ...
        for step in tbar:
            ...
            if torch.isnan(loss) or torch.isinf(loss):
                logger.warning(f"NaN or Inf detected in loss at step {step}. Skipping this step.")
                continue  # Skip this iteration if NaN or Inf is detected
            ...
            if step%3000 ==0 :
                print("Line 334,Changed this for generalizing")
