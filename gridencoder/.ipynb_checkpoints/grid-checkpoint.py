...
class GridEncoder(nn.Module):
    def __init__(self, input_dim=3, num_levels=16, level_dim=2,
        ...
        # parameters
        self.embeddings = nn.Parameter(torch.empty(offset, level_dim).cuda())
    ...
    def forward(self, inputs, bound=1):
        ...
        outputs = grid_encode(inputs.cuda(), self.embeddings.cuda(), self.offsets.cuda(), self.per_level_scale, self.base_resolution, inputs.requires_grad, self.gridtype_id, self.align_corners, self.interp_id)
